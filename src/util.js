/**
 * Taken from MetaMask:
 * https://github.com/MetaMask/metamask-extension/blob/09d81ac5f2c94d7730d2e981b4f05734858030bf/ui/helpers/utils/conversion-util.js#L140
 */
...
const converter = ({
  ...
  console.log(`Got a number!: ${value}, a type of ${typeof value}`)
  let convertedValue = fromNumericBase
    ? toBigNumber[fromNumericBase](value)
    : value;
  console.log(`Now it's ${convertedValue}, a ${typeof convertedValue}`)
...
export function convertToPrecision (jsFloatString, precision) {
  return conversionUtil(jsFloatString, {
    fromNumericBase: 'dec',
    toNumericBase: 'dec',
    numberOfDecimals: 18,
  });
